...
|---|------|---------|---------------|--------------------|
| 1 | 2026-09-14 | READMEs for lakehouse/agent/eval/report | Assumed folders at workspace root; they lived under `hiver/`. Had to search before writing. | Always locate real paths (`ls`/`glob`/`read`) before creating files — never assume layout. |
